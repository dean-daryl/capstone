    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/index.html", "/error", "/assets/**", "/icons/**", "/images/**", "/favicon.ico", "/*.js", "/*.css", "/*.json", "/*.png", "/*.svg", "/*.ico").permitAll()
                        .requestMatchers("/dashboard/**", "/login", "/signup", "/redirect").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/courses/**").hasAnyRole("TEACHER")
                        .requestMatchers(HttpMethod.GET, "/rag/documents/course/**").authenticated()
